...
$adduserou.add("ou=Remote,ou=Users,ou=DUM,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
$adduserou.add("ou=Local,ou=Users,ou=DUM,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
$adduserou.add("ou=Remote,ou=Users,ou=STF,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
$adduserou.add("ou=Local,ou=Users,ou=STF,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
$adduserou.add("ou=Remote,ou=Users,ou=ORL,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
$adduserou.add("ou=Local,ou=Users,ou=ORL,ou=EOBU,ou=ORG,dc=prod,dc=c2s2,dc=l-3com,dc=com")
